...
Los vectores son unidimensionales y deben ser (contener elementos) del mismo tipo. Aquí se muestran los diferentes tipos, y como crearlos. Los mas importantes tipos son *Numéricos*, *Texto*, y *Factores* (tipo especial en **R**).
...
Aquí se muestran funciones básicas para explorar los datos y como acceder a ciertos datos en especifico. Dentro de las funciones mas usadas están:
