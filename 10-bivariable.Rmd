...
* Logística: Es cuando la variable dependiente (respuesta) es cualitativa y tiene únicamente dos clases o niveles (Figura \@ref(fig:reg-logistica)). En este caso el resultado se puede dar como la clase predecida, o las probabilidades de pertenencia a cada clase, donde generalmente se asigna la clase predecida a la clase con más de un 50% de probabilidad. Por esto el eje vertical (y) se representa como probabilidades.

```{r reg-logistica, echo=FALSE, fig.cap='Ejemplo de regresión logística.'}
