...
La version interctiva de la Figura \@ref(fig:graficos-barra6) se muestra en la Figura \@ref(fig:graficos-inter3), la version usando *highcharter* se muestra en la Figura \@ref(fig:graficos-inter4). En la version de *highcharter*, si se cambia 'bar' por 'column', el grafico cambia orientacion.
...
La version interctiva, usando *highcharter*, de la Figura \@ref(fig:graficos-trans1) C se muestra en la Figura \@ref(fig:graficos-inter12); la version con *ggplotly* seria igual que las anteriores.
