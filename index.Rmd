...
Este documento se basa en el material creado para el curso **G-4101 Geología Numérica**, de la [Escuela Centroamericana de Geologia](geologia.ucr.ac.cr), [Universidad de Costa Rica](ucr.ac.cr), pero la idea es ir expandiendo los temas más allá del curso. El curso hace uso del software estadístico y de programación **R** [@R-base] para desarrollar la parte practica de los temas cubiertos en la teoría.
